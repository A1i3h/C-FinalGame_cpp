...
{
public:
    enum class EquipSlots { WEAPON = 0, HEADGEAR, CHEST_BODY, FOOTWEAR, RELIC, NO_SLOT };
...
public:
    ...
    inline const std::unordered_map<std::wstring, int>& GetStatsList() const { return m_StatList; } 
